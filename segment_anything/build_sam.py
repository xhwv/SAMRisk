...
from .modeling.earlyfusion import earlyfusion
from .modeling.image_encoder3D import ImageEncoderViT3D
from .modeling.image_encoder3D_Lora import ImageEncoderViT3Dlora
...
def _build_sam3D_ori(
    ...
    image_embedding_size = image_size // vit_patch_size
    sam = Sam3D(
        image_emb=earlyfusion(),
        # image_emb=earlyfusion(dim=4),
        image_encoder_lora=ImageEncoderViT3Dlora(
            depth=encoder_depth,
            embed_dim=encoder_embed_dim,
            img_size=image_size,
            mlp_ratio=4,
